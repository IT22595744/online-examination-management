...
<body>
  ...
  <div class="notification">
    ...
    <form action="AddNew.php" method="POST">
        ...
        <br>
        <input type="text" name="message" placeholder="message" width="90px" height="50px">
        <br>
        <button tye="submit" name="reg">Register</button>
    </form>
    <?php
      include 'config.php';
      ...
      foreach ($result3 as $row){
        ...
        echo $row['field'] . "<br>";
        echo $row['message'] . "<br>";?>
        <div><a href="delete.php?id=<?=$row['id'];?>">Delete</a></div>
        <div><a href="update.php?id=<?=$row['id'];?>">Update</a></div>
        <?php echo "<br><br>"; ?>
        <?php
